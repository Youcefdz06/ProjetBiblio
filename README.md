...
| 🗄️ Database | Stores users, books, purchases, and rentals |
...
<table>
  <tr>
    ...
    <td width="25%" align="center">🔄<br><strong>CIRCULATION</strong><br><br><code>user.py</code><br>Stock and purchases</td>
    <td width="25%" align="center">🗄️<br><strong>ARCHIVE</strong><br><br><code>database.py</code><br>SQLite persistence</td>
  </tr>
  <tr>
